...
import manifest from './gv-manifest.json';
...
export const gvProcessReelDuration = () => frames.length * HOLD;

export const GvProcessReel: React.FC = () => {
              ...
              {frames.map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    height: 4,
                    borderRadius: 999,
                    backgroundColor: i === active ? ACCENT : RULE,
                  }}
                />
              ))}
            </div>
